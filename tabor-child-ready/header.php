...
<div id="page" class="site top-spacer bottom-spacer">
	...
	<header id="masthead" class="site-header drop-in drop-in--from-top" role="banner">
		...
		<div class="container max-width">
							...
							<?php
								wp_nav_menu(
									array(
										...
										'menu_class'     => 'header-font medium smooth gray h5 list-reset',
										'depth'          => 1,
						...
						<?php if ( has_nav_menu( 'primary' ) ) : ?>
							...
							wp_nav_menu(
								array(
									...
									'menu_class'     => 'primary-menu header-font medium smooth gray h5 list-reset',
									'depth'          => 2,
								)
							);
							?>
			...
			<div class="site-branding-text">
				...
				?>
					<p class="site-description header-font medium smooth gray h5"><?php echo wp_kses( $description, $allowed_html ); ?></p>
				<?php endif; ?>
			</div>
	...
	<div id="content" class="site-content">
		<div class="advertiser-sidebar">
			<div id="banner300">
				<?php get_template_part( 'advertiser-large' ); ?>
			</div>
		</div>
