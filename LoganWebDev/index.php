...
<div id="columns" class="card-columns">
  <div class="card text-center">
    <img class="card-img-top" src="/wp-content/themes/loganwebdev/img/southeast.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card p-3">
  <img class="card-img-top" src="/wp-content/themes/loganwebdev/img/adult-group.jpg" alt="Card image cap">
  ...
  <div class="card text-center">
    <img class="card-img-top" src="/wp-content/themes/loganwebdev/img/calendar-example.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card text-center">
  <img class="card-img-top"  src="/wp-content/themes/loganwebdev/img/logos.png" alt="Card image">    
    <div class="card-body">
  ...
  <div class="card text-center">
    <div class="card-body">
    <img class="card-img-top" src="/wp-content/themes/loganwebdev/img/analytics.png" alt="Card image cap">
  ...
  <div class="card text-center">
  <img class="card-img-top"  src="/wp-content/themes/loganwebdev/img/gravity-forms.png" alt="Card image">
    <div class="card-body">
  ...
  <div class="card text-center">
    <div class="card-body">
    <img class="card-img-top" src="/wp-content/themes/loganwebdev/img/email.png" alt="Card image cap">
